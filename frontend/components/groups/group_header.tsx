      ...
      <div className="info">
        ...
        <ul>
          ...
          <li className="members">
            ...
            <p>{group === undefined ? "..." : group.members.length} member{group.members.length === 1 ? "" : "s"} - {group === undefined ? "..." : group.public ? "Public" : "Private"} group</p>
          </li>

          <li className="organizers">
            <svg className="line-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            {/* Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc.  */}
